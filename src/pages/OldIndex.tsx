...
const Index = () => {
    ...
    return (
        <div className='min-h-screen bg-[#1A1A1A] text-white overflow-hidden'>
                        ...
                        {[
                            {
                                ...
                                description:
                                    "Advanced algorithms for precise market analysis",
                            },
                            {
                                icon: <Zap className='w-6 h-6 text-primary' />,
                                title: "Fast Execution",
                                description:
                                    "Lightning-fast order execution for optimal results",
                            },
                            {
                                icon: (
                                ...
                                title: "Safe & Reliable",
                                description:
                                    "Highest security standards for your capital",
                            },
                        ].map((feature, index) => (
                            <div
                                key={index}
            ...
            <section
                id='statistics'
                className='py-20 px-4 bg-black/30 relative overflow-hidden'
            >
                ...
                <div className='max-w-4xl mx-auto text-center animate-on-scroll relative z-10'>
                    <div className='glass-effect p-8 rounded-2xl glow'>
                        ...
                        <p className='text-gray-400 mb-8 max-w-2xl mx-auto'>
                            Join our Telegram Alpha Group now and get more
                            information about our trading bot and discover
                            exclusive features! 🚀
                        </p>
                        <a
                            href='https://bit.ly/AuV-Telegram'
